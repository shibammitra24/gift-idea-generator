...
export default function PromptWindow() {
  ...
  const addInterest = (interest: string) => {
    ...
    if (interest && INTERESTS.includes(interest) && !interests.includes(interest)) {
  ...
  return (
    ...
    >
        ...
        <div className="flex-1 flex flex-col items-center relative">
          ...
          <div className="w-full max-w-md min-h-[96px] bg-[#191816] border border-[#333] rounded-xl flex flex-wrap items-start gap-2 p-4 relative">
            ...
            <div className="relative">
              ...
              />
              {(showSuggestions || inputRef.current === document.activeElement) && filteredSuggestions.length > 0 && (
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-4">
        <Button className="bg-[#FF8200] hover:bg-orange-600 text-black font-semibold px-8 py-3 rounded-full text-lg">
          Generate Ideas
        </Button>
        <Button
          variant="outline"
